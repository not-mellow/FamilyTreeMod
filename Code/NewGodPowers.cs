...
namespace FamilyTreeMod
{
    class NewGodPowers
    {
        ...
        public static void initPowers()
        {
            ...
            DropAsset convertDrop = AssetManager.drops.clone("convertDrop", "blessing");
            convertDrop.action_landed = new DropsAction(NewActions.action_convert_city);

            GodPower cityConvert = AssetManager.powers.clone("cityConvert", "_dropBuilding");
            cityConvert.name = "cityConvert";
            cityConvert.dropID = "convertDrop";
            cityConvert.fallingChance = 0.01f;
            cityConvert.click_power_action = new PowerAction(AssetManager.powers.spawnDrops);
		    cityConvert.click_power_action = (PowerAction)Delegate.Combine(cityConvert.click_power_action, new PowerAction(AssetManager.powers.flashPixel));
